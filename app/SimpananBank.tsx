...
const MOCK_ASSETS = {
  bank: [
    { id: '1', name: 'Simpanan Bank', bank: 'Maybank', amount: 5500.00 },
    { id: '2', name: 'Akaun Semasa', bank: 'CIMB', amount: 0.00 },
    { id: '3', name: 'Akaun FD', bank: 'Public Bank', amount: 0.00 }
  ],
};

export default function SimpananBankScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Simpanan Bank</Text>
        <View style={{ width: 24 }} />
      </View>
      <FlatList
        data={assets}
